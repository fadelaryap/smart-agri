...
ModbusMaster232::ModbusMaster232(uint8_t u8MBSlave, Stream &_serial) : swSer(&_serial)
{
  _u8SerialPort = 0;
  _u8MBSlave = u8MBSlave;
}
...
@ingroup setup
*/
// commented because Stream has no begin function
...
uint8_t ModbusMaster232::get_id(){
