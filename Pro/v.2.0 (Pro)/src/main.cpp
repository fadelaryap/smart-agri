/* 
   Automatic Weather Stasion V.1.3 (PRO)
...
void logSDCard() {
  dataMessage = "&D=" + tanggal2 + "&T=" + waktu + "&C0=" + String(result[2]) + "&C1=" + 
                String(result[3]) + "&C2=" + String(result[4]) + "&C3=" + String(result[5]) + "&C4=" + String(result[6]) + "&C5=" + String(result[7]) + "&C6=" + String(result[8]) + "&C10=" + String(result[9]) + "&C11=" + String(result[10]) + "&R=1" + '\n';
...
void sendToServer() {
  String requestData = "&C0=" + String(voltage) + "&C1=" + String(result[8]) + "&C2=" + String(result[4]) + "&C3=" + String(power) + "&C4=0.00&C5=" + String(result[2]) + "&C6=" + String(result[3]) + "&C7=" + String(result[7]) + "&C8=" + String(result[5]) + "&C9=" + String(result[6]) + "&C10=" + String(result[9]) + "&C11=" + String(result[10]);
...
void sendToServer4() {
  String requestData = "&C0=" + String(voltage) + "&C1=" + String(result[8]) + "&C2=" + String(result[4]) + "&C3=0.00&C4=0.00&C5=" + String(result[2]) + "&C6=" + String(result[3]) + "&C7=" + String(result[7]) + "&C8=" + String(result[5]) + "&C9=" + String(result[6]) + "&C10=" + String(result[9]) + "&C11=" + String(result[10]);
  Serial.println(requestData); 
  Serial.println("Performing HTTP POST request...");
  client2.print("GET ");
  // String buatkey = "/feed/api2.php?K=" + String(key) + String(requestData);
...
void loop()
{
  ...
  if(!maintananceState){
    ...
    if ((bagi == 0) && (detik2 == 0)){
      ...
      String jadicsv = String(tanggal2) + ',' + String(waktu) + ',' + String(result[2]) +',' + String(result[3]) +',' + String(result[4]) + ',' + String(result[5]) + ',' + String(result[6]) + ',' + String(result[7]) + ',' + String(result[8]) + ',' + String(result[9]) + ',' + String(result[10]) + ',' + String(voltage) +"\n";
